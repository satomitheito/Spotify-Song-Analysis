...
* [x] Use clustering algorithms to develop clusters based on quantitative data and understand connection to song ranking or popularity
* [x] Analyze results to determine the characteristics of popular songs
* [x] Determine if there are clusters that can then be used to make playlists of similar songs
* [x] Provide comments about process and informative technical markdown cells

#### Report:

* [x] Write executive summary
* [x] Write about key insights provided by EDA
* [x] Write about key insights provided by unsupervised learning
* [x] Provide informative visualizations
* [x] Write about Business Implications of key findings
* [x] Write about Recommendations
